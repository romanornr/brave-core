...
class DatabaseServerPublisherList : public DatabaseTable {
 public:
  explicit DatabaseServerPublisherList(bat_ledger::LedgerImpl* ledger);
  ~DatabaseServerPublisherList() override;
