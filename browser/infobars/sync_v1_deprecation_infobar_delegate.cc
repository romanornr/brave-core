...
void SyncV1DeprecationInfoBarDelegate::Create(InfoBarService* infobar_service,
  ...
  // We still show the infobar if the sync flag is off
  // as turning it off by default was not user-driven.
  // User has still indicated interest in sync by using sync-v1
  // when it was last enabled by default.
